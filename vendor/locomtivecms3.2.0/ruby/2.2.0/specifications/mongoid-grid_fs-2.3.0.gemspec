# -*- encoding: utf-8 -*-
# stub: mongoid-grid_fs 2.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<mongoid>, ["< 7.0", ">= 3.0"])
      s.add_runtime_dependency(%q<mime-types>, ["< 4.0", ">= 1.0"])
      s.add_development_dependency(%q<minitest>, ["< 6.0", ">= 5.7.0"])
    else
      s.add_dependency(%q<mongoid>, ["< 7.0", ">= 3.0"])
      s.add_dependency(%q<mime-types>, ["< 4.0", ">= 1.0"])

# -*- encoding: utf-8 -*-
# stub: locomotivecms_steam 1.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<mongo>, ["~> 2.2.7"])
      s.add_development_dependency(%q<origin>, ["~> 2.2.0"])
      ...
      s.add_dependency(%q<mongo>, ["~> 2.2.7"])
      s.add_dependency(%q<origin>, ["~> 2.2.0"])
